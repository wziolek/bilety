...
<!-- Modal -->
		...
		<div class="container page">
        	...
        	<div class="container">
	        	<div class="btn-group">
				  	<button type="button" id="show-html" class="btn btn-info">Orders</button>
				  	<?php
				    	...
				    	echo("</table>");	
	        		?>
				  	<button type="button" id="show-js" class="btn btn-info">Users</button>
			  		<?php
					    ...
					    echo("<table cellpadding=\"2\" border=1>");
						    ...
						    echo "</table>";  
        			?>
			  		<button type="button" id="show-css" class="btn btn-info">Sony</button> 
			  			<?php
